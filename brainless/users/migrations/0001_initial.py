    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_or_phone', models.CharField(max_length=100, unique=True, validators=[users.validators.email_or_phone_validator])),
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('role1', 'Role1')], default='user', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['email_or_phone'], name='users_user_email_o_93f337_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
